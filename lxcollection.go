...
// FirstIndex, returns the first index of the target string, or -1 if no match is found.
// // Example:
...
// FindAny, returns true if one of the strings in the slice satisfies the predicate f.
// // Example:
...
// FindAll, returns true if all of the strings in the slice satisfy the predicate f.
// // Example:
